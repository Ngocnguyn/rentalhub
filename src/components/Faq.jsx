...
function Faq() {
  ...
  const getClassAnswer = (id) => {
    return activeQ === id
      ? "!max-h-[200px] py-[28px] px-[45px] transition-all duration-400 max-sm:!max-h-[300px]"
      : "";
  };

  const getClassQuestion = (id) => {
    return activeQ === id ? "bg-[#ff4d30] text-white shadow-lg" : "";
  };

  return (
    <>
      <section className=" py-[100px] bg-auto bg-no-repeat ">
        <div className="container">
          <div className="flex flex-col text-black">
            <div className="flex flex-col m-auto text-center max-w-[800px] ">
              <h5 className="text-[22px] font-semibold">FAQ</h5>
              <h2 className="text-[42px] mb-[17px] font-bold">
            ...
            <div className="flex flex-col items-center mt-[70px]">
              <div className="flex flex-col text-black bg-white shadow-lg w-[800px] cursor-pointer max-md:w-full">
                <div
                  id="q1"
                  onClick={() => openQ("q1")}
                  className={`flex justify-between items-center shadow-md py-[18px] px-[45px] transition-all duration-150  ${getClassQuestion(
                    "q1"
                  )}`}
                >
                ...
                <div
                  id="q1"
                  onClick={() => openQ("q1")}
                  className={`font-rubik text-[16px] text-[#706f7b] overflow-hidden max-h-0 ${getClassAnswer(
                    "q1"
                  )}`}
                >
